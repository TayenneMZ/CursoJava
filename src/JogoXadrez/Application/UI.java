...
import JogoXadrez.Chess.ChessPosition;
...
public class UI {
    ...
    private static void printCapturedPieces(List<ChessPiece> captured) {
        List<ChessPiece> white = captured.stream().filter(element -> element.getColor() == Color.WHITE).collect(Collectors.toList());
        List<ChessPiece> black = captured.stream().filter(element -> element.getColor() == Color.BLACK).collect(Collectors.toList());
